    ...
    if (this.state.done !== true) {
      return (
        <View style={styles.container}>
          <Text style={styles.texto1}>Ingrese el país que busca, en inglés por favor :v</Text>
          <TextInput
            style={{
              height: 40,
              width: 250,
      ...
      return (
        <View style={styles.container}>
          <Text style={styles.texto1}>Ingrese el país que busca, in inglish please :v</Text>
          <TextInput
            style={{
              height: 40,
              width: 250,
            ...
            onChangeText={this.handlerText.bind(this)}
          />
          <Button title="Mostrarme la info" color="#78002e" onPress={this.handlerButton.bind(this)} />
          <Text>Nombre: {this.state.response.name} </Text>
          <Text>Capital: {this.state.response.capital}</Text>
          <Text>Población: {this.state.response.population} millones de habitantes</Text>
          <Text>Bandera:</Text>
          <Text>Continente: {this.state.response.region} </Text>
          <Image source={{ uri: this.state.response.flag }}
            style={{
              width: 51,
              height: 51,
              resizeMode: 'contain'
